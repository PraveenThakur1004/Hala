...
class HotListController: UIViewController {
    ...
    */
    ...
    func getHotList(){
        ...
        let urlString = URLConstants.baseUrl + URLConstants.hotList
            print(urlString)
    ...
    func removeHot(path : IndexPath){
        ...
        FTIndicator.showToastMessage("User removed from the hotlist")
...
extension HotListController : UITableViewDelegate , UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.deleteBtn.setTitle("REMOVE", for: .normal)
        ...
        cell.deleteBtn.addTarget(self, action: #selector(HotListController.deleteAction(notify:)), for: .touchUpInside)
